<div class="form-group row">
    ...
    <input id="denominacion" type="text" class="form-control{{ $errors->has('denominacion') ? ' is-invalid' : '' }} col-sm-6" name="denominacion" value="{{ $period->denominacion }}" placeholder="Ingrese Denominación del periodo Académico" required autofocus>
...
<div class="form-group row">
    <div class="col-md-12 form-inline justify-content-center">
        <textarea id="descripcion" class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }} col-sm-6" name="descripcion" value="{{ old('descripcion') }}" placeholder="Ingrese Descripción">{{ $period->descripcion }}</textarea>
